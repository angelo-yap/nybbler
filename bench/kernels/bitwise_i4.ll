; bitwise_i4 -- 4-bit field bitwise pass over a byte stream.
;
; NYB_DESC: <32 x i4> xor / and / or mask pass
; NYB_OUT_BYTES_PER_VEC: 16
;
; Same shape as mask_i1/bitwise_i2, one width up. Expect ~1.0x for the same
; reason: bitwise ops are bit-independent, so the legalizer already handles
; <K x i4> bitwise as bytes without help. See docs/benchmarks.md.
